...
# Configuration - Update these according to your CompreFace setup
CONFIG = {
    ...
    "verification_threshold": 0.88  # 70% similarity threshold
}
...
def capture_face(frame, image_type):
...
def main():
    ...
    print("Press 's' to capture source face, 't' for target face, 'q' to quit")
    ...
    try:
        while True:
            ...
            if key == ord('q'):
                ...
                source_data = capture_face(frame, "source")
                ...
                last_capture_time = current_time
                target_data = capture_face(frame, "target")
                if not target_data:
                    continue
